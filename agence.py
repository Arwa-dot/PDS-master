...
#pour version DB
    def readAll(self):
        client = MongoClient("mongodb+srv://ArwaM:ArwaM@cluster0.st42f.mongodb.net/test")
        ...
        for item in datas:
            ...
            self.data = self.data.concat(row, ignore_index=True)
